...
public class RedisUtil {
     ...
     * @return
     */
    public Boolean zSet(String key, String value,double d){
    ...
    public Long allRemove(String key,int start,int end){
        try {
     ...
     * @return
     */
    public Double incrementScoreZset(String key, Object values,Double d){
        try {
            return redisTemplate.opsForZSet().incrementScore(key,values,d);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
