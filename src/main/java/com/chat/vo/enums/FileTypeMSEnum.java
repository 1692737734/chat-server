...
public enum FileTypeMSEnum {
    ...
    private FileTypeMSEnum(String key, String value){
        this.key = key;
        this.value = value;
    }
    //根据key获取枚举
    public static FileTypeMSEnum getFileTypeMSEnum(String key){
        if("".equals(key)){
            return null;
        }
        for(FileTypeMSEnum temp: FileTypeMSEnum.values()){
    ...
    public static FileTypeMSEnum getFileTypeMSEnumByValue(String value){
